...
import client.ui.notification.Notification;
import client.ui.notification.NotificationLevel;
...
public class InventoryManager extends Module {
   ...
   public static int getMaxBlockSize() {
      return (int)((InventoryManager) Shiori.getInstance().getModuleManager().getModule(InventoryManager.class)).maxBlockSize.getCurrentValue();
   }

   public static boolean shouldKeepProjectile() {
      return ((InventoryManager) Shiori.getInstance().getModuleManager().getModule(InventoryManager.class)).keepProjectile.getCurrentValue();
   }

   public static int getMaxProjectileSize() {
      return (int)((InventoryManager) Shiori.getInstance().getModuleManager().getModule(InventoryManager.class)).maxProjectileSize.getCurrentValue();
   }

   public static int getMaxArrowSize() {
      return (int)((InventoryManager) Shiori.getInstance().getModuleManager().getModule(InventoryManager.class)).maxArrowSize.getCurrentValue();
   }

   public static int getWaterBucketCount() {
      return (int)((InventoryManager) Shiori.getInstance().getModuleManager().getModule(InventoryManager.class)).waterBucketCount.getCurrentValue();
   }

   public static int getLavaBucketCount() {
      return (int)((InventoryManager) Shiori.getInstance().getModuleManager().getModule(InventoryManager.class)).lavaBucketCount.getCurrentValue();
   }
   ...
   public void onMotion(EventMotion e) {
      if (e.getType() == EventType.PRE) {
         if (!(mc.screen instanceof ClickGUI) && !this.checkConfig()) {
            ...
            Shiori.getInstance().getNotificationManager().addNotification(notification);
            this.toggle();
            return;
         }
         ...
         if (ChestStealer.isWorking()
            || Shiori.getInstance().getModuleManager().getModule(Scaffold.class).isEnabled()
