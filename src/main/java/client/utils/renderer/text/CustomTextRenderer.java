package client.utils.renderer.text;

import client.utils.renderer.DrawMode;
import client.utils.renderer.GL;
import client.utils.renderer.Mesh;
import client.utils.renderer.ShaderMesh;
...
public class CustomTextRenderer {
   ...
   public CustomTextRenderer(String name, int size, int from, int to, int textureSize) {
      InputStream in = this.getClass().getResourceAsStream("/assets/shiori/fonts/" + name + ".ttf");
      if (in == null) {
