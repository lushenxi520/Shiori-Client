...
public class PlayerUtils {
   ...
   public static net.minecraft.world.level.block.state.BlockState blockRelativeToPlayer(int offsetX, int offsetY, int offsetZ) {
      return mc.level.getBlockState(
         new net.minecraft.core.BlockPos(
            (int) Math.floor(mc.player.getX()) + offsetX,
            (int) Math.floor(mc.player.getY()) + offsetY,
            (int) Math.floor(mc.player.getZ()) + offsetZ
         )
      );
   }
